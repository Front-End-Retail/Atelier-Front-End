...
app.post("/qanda/answer", (req, res) => {
  ...
  axios
    .post(
      `https://app-hrsei-api.herokuapp.com/api/fec2/hr-rfe/qa/questions/${req.body.question_id}/answers`,
      answerObject,
      {
        headers: {
...
app.put("/review/put", (req, res) => {
  axios
    .put(
      `https://app-hrsei-api.herokuapp.com/api/fec2/hr-rfe/reviews/${req.body.review_id}/${req.body.path}`,
      {},
      { headers: authObject }
    )
    .then(() => {
