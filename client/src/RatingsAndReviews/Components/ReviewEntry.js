    ...
    if (e.target.textContent === "Report") {
      !toggleReport
        ? (setToggleReport(true),
          putRequest(review.review_id, "report"),
    ...
    <div className="review-entry" data-testid="randr-entry">
      <div className="entry-top-container">
        <StarAverage
          ...
          colorOn={"rgb(255, 193, 7)"}
          colorOff={"rgb(255,255,255)"}
        />
        <p>
      ...
      {review.body.length < 250 && (
        <p className="review-body">
          {searchTerm.length < 2
            ? review.body
            : highlightWord(review.body, searchTerm)}
        </p>
      )}
      {!toggleBody ? (
        <div className="review-body">
          {review.body.length > 250 && (
            <p className="review-body">
              ...
              <button className="show-more" onClick={expandBody}>
                show more
              </button>
            </p>
          )}
      ...
      {review.recommend && (
        <p className="review-tile-recommend">
      ...
      <p>
        ...
        {helpfulText === "No" ? (
          <a
            ...
            id="helpfulness-button"
            className=" review-links"
          >
            {helpfulText} {review.helpfulness + 1}
          </a>
        ) : (
          <a
            onClick={handlePutRequest}
            ...
            className=" review-links"
          >
            {helpfulText} {review.helpfulness}
          </a>
        )}
        <a
          onClick={handlePutRequest}
          id="report-button"
          className="review-links toggle-line"
        >
          {reportText}
        </a>
      </p>
