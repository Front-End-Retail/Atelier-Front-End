    ...
    {/* {makeStarAverage(rating)} */}
      ...
      <svg className="linear-gradient-template">
        <linearGradient id="quarter-star" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="25%" style={{stopColor: "rgb(255, 193, 7)"}}></stop>
            <stop offset="25%" style={{stopColor: "rgb(228, 229, 233)"}}></stop>
        </linearGradient>
      </svg>
      <svg className="linear-gradient-template">
      ...
      <svg className="linear-gradient-template">
        <linearGradient id="three-quarter-star" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="75%" style={{stopColor: "rgb(255, 193, 7)"}}></stop>
            <stop offset="75%" style={{stopColor: "rgb(228, 229, 233)"}}></stop>
        </linearGradient>
      </svg>
      <svg className="linear-gradient-template">
